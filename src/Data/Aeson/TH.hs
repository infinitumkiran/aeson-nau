...
unknownFieldFail tName rec key =
    fail $ missingFieldErr (Just $ tName ++ "(" ++ rec ++ ")") key

noArrayFail :: String -> String -> Parser fail
noArrayFail t o = fail $ typeMismatchErr (Just t) "Array" o

noObjectFail :: String -> String -> Parser fail
noObjectFail t o = fail $ typeMismatchErr (Just t) "Object" o

firstElemNoStringFail :: String -> String -> Parser fail
firstElemNoStringFail t o = fail $ typeMismatchErr (Just t) "Array of 2 elements where the first element is a String" o

wrongPairCountFail :: String -> String -> Parser fail
wrongPairCountFail t n =
    fail $ typeMismatchErr (Just t) "Object with a single tag/contents pair" n

noStringFail :: String -> String -> Parser fail
noStringFail t o = fail $ typeMismatchErr (Just t) "String" o

noMatchFail :: String -> String -> Parser fail
noMatchFail t o =
    fail $ typeMismatchErr (Just t) "String with the tag of a constructor" o

not2ElemArray :: String -> Int -> Parser fail
not2ElemArray t i = fail $ typeMismatchErr (Just t) "Array of 2 elements" (show i)

conNotFoundFail2ElemArray :: String -> [String] -> String -> Parser fail
conNotFoundFail2ElemArray t cs o =
    fail $ typeMismatchErr (Just t) ("2-element Array with tag or content as" ++ "[" ++ intercalate ", " cs ++ "]") o

conNotFoundFailObjectSingleField :: String -> [String] -> String -> Parser fail
conNotFoundFailObjectSingleField t cs o =
    fail $ typeMismatchErr (Just t) ("[" ++ intercalate ", " cs ++ "]") o
...
parseTypeMismatch' conName tName expected actual =
    fail $ typeMismatchErr (Just $ tName ++ "(" ++ conName ++ ")") expected actual
